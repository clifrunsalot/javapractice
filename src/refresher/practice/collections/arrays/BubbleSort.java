...
public class BubbleSort {
	...
	useBubbleSort([1, 1, 2, 2, 4, 5, 5, 5, 98, 98]) => [1, 1, 2, 2, 4, 5, 5, 5, 98, 98]
	useBubbleSort([3, 3, 6, 6, 7, 8, 8, 9, 9, 9]) => [3, 3, 6, 6, 7, 8, 8, 9, 9, 9]
	useBubbleSort([7, 7, 1, 1, 4, 4, 2, 9, 9, 33, 33, 33]) => [1, 1, 2, 4, 4, 7, 7, 9, 9, 33, 33, 33]
	useBubbleSort([888, 888, 5, 5, 1, 2, 2, 4, 4]) => [1, 2, 2, 4, 4, 5, 5, 888, 888]
	useBubbleSort([77, 65, 65, 3, 3]) => [3, 3, 65, 65, 77]
	useBubbleSort([1, 1]) => [1, 1]
	useBubbleSort([]) => []
