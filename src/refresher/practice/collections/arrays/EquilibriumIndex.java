...
//		LogIt.logTest("findAnIndex", "", LogIt.toIntString(equals.toArray()));
	...
	public static void main(String[] args) {
	    ...
	    LogIt logger = new LogIt(EquilibriumIndex.class.getName()).getLogger();
	    
		int[] ary1 = { -1, 3, -4, 5, 1, -6, 2, 1 };
		logger.info("findAnIndex", LogIt.toIntString(ary1), "" + findAnIndex(ary1));

		int[] ary2 = { -1, -6, -2, 1, -1, -6, -2 };
		logger.info("findAnIndex", LogIt.toIntString(ary2), "" + findAnIndex(ary2));

		int[] ary3 = { 3, 1, -4, 5, -6, 2, 3 };
		logger.info("findAnIndex", LogIt.toIntString(ary3), "" + findAnIndex(ary3));
	}
