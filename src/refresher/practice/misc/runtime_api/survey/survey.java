package refresher.practice.misc.runtime_api.survey;
...
class MySurvey extends JFrame implements ActionListener {
	...
	public void invokeCprogram() {
		try {
			...
			if ((ch = good_stream.read()) != -1) {
				...
				JOptionPane.showMessageDialog(null, good_string, "Information", JOptionPane.INFORMATION_MESSAGE);
			}
		} catch (Exception e) {
			System.out.println(e);
			JOptionPane.showMessageDialog(null,
					e.toString() + ":\n" + "There was a problem invoking the external process.", "Error",
	...
	public void writeAnswer(String option) {
		try {
			...
			JOptionPane.showMessageDialog(null, "Could not read input", "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	private JRadioButton one_radio, two_radio, three_radio, four_radio;
