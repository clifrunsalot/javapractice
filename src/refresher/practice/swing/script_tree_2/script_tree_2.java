package refresher.practice.swing.script_tree_2;
...
class SCAFrame extends JFrame implements MouseListener, ActionListener {
	...
	public void addToolBarButton(JToolBar bar, boolean useImage, String label, String help) {
	...
	public void addNodeToParent(CheckBoxNode parent, String searchString, String[] nodeName, String[] description) {
		...
		Enumeration_loop: for (Enumeration children = parent.children(); children.hasMoreElements();) {
	...
	public void setUpTreeModel() {
		...
		String[] categories = { "Audio", "FPGA", "Modem", "Red and Black", "Red and Black GPP", "Serial", "Test APs",
				"Transceiver" };
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (source.equals("ExitMenuItem")) {
			...
			try {
				JOptionPane.showMessageDialog(this, "This feature is not implemented yet", "About",
			...
			JLabel messageLabel = new JLabel(
					"<HTML>Test Platform Tool</HTML>");
			messageLabel.setFont(arialFont);

			try {
				JOptionPane.showMessageDialog(this, messageLabel, "About", JOptionPane.INFORMATION_MESSAGE, null);
			} catch (HeadlessException e) {
				System.out.println("Unable to process menu request");
			}
...
class CheckRenderer implements TreeCellRenderer {
	...
	public Component getTreeCellRendererComponent(JTree tree, Object value, boolean isSelected, boolean expanded,
		...
		renderer.getTreeCellRendererComponent(tree, value, isSelected, expanded, leaf, row, hasFocus);
		return panel;
	}
}
	...
	public void selectChildren(boolean b) {
		if (children != null) {
			...
			while (enum1.hasMoreElements()) {
				CheckBoxNode node = (CheckBoxNode) enum1.nextElement();
				TestObject obj = (TestObject) getUserObject();
				obj.testThis(b);
				node.setSelected(b);
			}
