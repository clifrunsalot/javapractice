...
/**
 * Instantiates the Debug class. Essentially, it offers a shorter way to call
 * the print command when the application is being debugged.
 */
public class Debug {
	Debug() {
	}
	 ...
	 *            An Array of Objects
	 * @param rows
	 *            Number of rows to cycle through
	 * @param cols
	 *            Number of columns per row to cycle through
	 * 
	 * @return void
	 */
