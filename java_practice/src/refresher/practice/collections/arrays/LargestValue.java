...
public class LargestValue {
    ...
    public static void main(String[] args) {
        ...
        logger.logFunc("getLargestValue", LogIt.toIntString(ary1), "" + getLargestValue(ary1));
        logger.logFunc("getLargestValue", LogIt.toIntString(ary2), "" + getLargestValue(ary2));
        logger.logFunc("getLargestValue", LogIt.toIntString(ary3), "" + getLargestValue(ary3));
    }
