package refresher.practice.misc.console.currentTime;
...
public class currentTime {
	public static void main(String[] args) {
		...
		System.out.println("" + midnight.get(GregorianCalendar.YEAR) + "," + midnight.get(GregorianCalendar.MONTH) + ","
				+ midnight.get(GregorianCalendar.DATE) + ", " + midnight.get(GregorianCalendar.HOUR) + ","
				+ midnight.get(GregorianCalendar.MINUTE) + "," + midnight.get(GregorianCalendar.SECOND));
