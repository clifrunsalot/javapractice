...
class Show_sine_curve {
	...
	static double num; // must be static because it will use a value from aother
						// method
	...
	public static void main(String Args[]) {
		...
		for (int x = 0; x <= 20; x++) {
			...
			// selection: prints values ranging from 0 thru 20 as single digits
			// as in
			// where 10 is represented by 0 and 11 thru 20 is represented by the
			// second digit in the number
			...
			y = ((int) ((java.lang.Math.sin(w)) * 10)) + 10; // calculated sine
																// value of w,
																// which is then
																// added to 10
			// so that no negative value is plotted

			num = (java.lang.Math.sin(w) * 10) + 10; // keeps decimal form of
														// sine value of w
