package refresher.practice.swing.runlevel;
...
class SystemLog extends JFrame implements ActionListener {
	...
	StringBuffer extractRunLevel(StringBuffer b) {
		...
		// 1905 1066056194 DEBUG SS.UNIT.Proc Man Changing the Run Level to: 1
		// because a configuration event occurred.
	...
	StringBuffer extractProcessName(StringBuffer b) {
		...
		// 1905 1066056194 INFORMATION SS.UNIT.ProcOpns Starting process
		// /h/AFATDS/bin/manage_tactical_subnet with PID of 2580
	...
	private JPanel mainPanel, titlePanel, timePanel, indicatorPanel, buttonPanel;
	private JScrollPane scrollPane;
	private JTextArea textArea;
	private Container contentPane;
	private JLabel runlevelLabel, timeLabel, indicatorLabel;
	private Border etchedBorder;
	private Timer timer, indicatorTimer;
	private boolean DEBUG;
	private MyPrint p;
	private JButton exitButton, startButton, stopButton;
