...
/**
 * Instantiates the DataFileFilter class. This class accepts all files or files
 * ending in ".dat".
 */
public class DataFileFilter extends FileFilter {

	/**
	 * Returns True if the file object is either a directory or ends with
	 * ".dat".
	 * 
	 * @param file
	 *            File object
	 * 
	 * @return True if the file object is either a directory or ends with
	 *         ".dat".
	 */
	...
	/**
	 * Returns the description for the file type to be displayed in the Open
	 * File Dialog."
	 * 
	 * @param none
	 * 
