...
/**
 * This class provides a simpler way to position the application on the monitor
 * screen. Passing one of the specified strings to the setLocation method will
 * place the top-left corner of the frame of the application in one of the
...
public class Location {
	...
	/**
	 * This is a variable of the Toolkit class that gives the program access to
	 ...
	 * 
	 * @param c
	 *            is the container belonging to the application.
	 */
	...
	/**
	 * Sets the location of the application container on the monitor screen. The
	 * direction can be one of the following values. Any other value will place
	 * the top-left corner of the application in the center of the screen.
	 * 
	 * <ul>
	 ...
	 * 
	 * @param direction
	 *            is one of the strings listed above
	 */
	public void setLocation(String direction) {
		...
		String[] directionArray = { "n", "s", "e", "w", "ne", "nw", "se", "sw" };
		...
		if (directionConverted != -1) {
			...
			/**
			 * Locate upper left corner of container and position it in the
